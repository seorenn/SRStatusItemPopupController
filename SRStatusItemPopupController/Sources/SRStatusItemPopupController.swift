...
public class SRStatusItemPopupController: NSObject {
    ...
    public init(viewController: NSViewController, image: NSImage?, alternateImage: NSImage?) {
    ...
    public func showPopover(animated: Bool) {
        ...
        self.popover.showRelativeToRect(NSZeroRect, ofView: self.statusItemButton, preferredEdge: NSRectEdge.MaxY)
    }
